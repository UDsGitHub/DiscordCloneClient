...
import { DirectMessagesSidebar, DirectMessagesTopbar } from "../../components";
...
const DirectMessages = (props: DirectMessagesProps) => {
  ...
  const FriendListItem = ({ friend }: FriendListItemProps) => {
    return (
      <li className="p-2 hover:bg-grey-400/10 rounded-md flex items-center">
        <UserAvatar />
        <div className="ml-2">
